...
test_transform = transforms.Compose([transforms.Resize(640),
...
def process_frame(img_bgr):
    ...
    ## onnx runtime 预测
    ort_inputs = {'images': input_tensor} # onnx runtime 输入
    pred_logits = ort_session.run(['human'], ort_inputs)[0] # onnx runtime 输出
